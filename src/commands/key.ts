...
export async function keySetCommand(_options: GlobalOptions): Promise<number> {
  assertWindows();
...
export function keyCheckCommand(options: GlobalOptions): number {
...
export async function keyRemoveCommand(): Promise<void> {
  assertWindows();
